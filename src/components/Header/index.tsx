  ...
  const Web = <div className='nav-div' >
    <div className="nav-content" >
      ...
      <div className="nav-search"  >
        ...
        <img className="nav-search-img" src={search} alt="" />
      </div>
      ...
      <div    >
        {changeToken ?
          <div className="nav-token" onClick={() => {
            ...
            <img src={eth} className="img-search" alt="" />
          </div> :
          <div className="nav-token" onClick={() => {
            setChangeToken(!changeToken);
          }} >
            <img src={usdc} className="img-search" alt="" />
      ...
      <div className="nav-car" >
        <img src={car} className="img-search" alt="" />
      </div>
    </div>
